...
public class FileTransferService extends IntentService {
    ...
    public static final String ACTION_SEND_FILE = "cnc.hx.SEND_FILE";
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (intent.getAction().equals(ACTION_SEND_FILE) && fileUri != null && host != null) {
            ...
            try {
                ...
                Log.d("FileTransferService", "Client: Data written");
            } catch (IOException e) {
